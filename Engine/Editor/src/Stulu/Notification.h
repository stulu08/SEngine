...
#define NOTIFY_MAX_NOTIFICATIONS_COUNT      20
...
public:
    ...
    inline const char* getIcon()
    {
        ...
        case ImGuiToastType::None:
            return nullptr;
        case ImGuiToastType::Success:
            return ICON_FK_CHECK_CIRCLE; // Font Awesome 6
        case ImGuiToastType::Warning:
            return ICON_FK_EXCLAMATION_TRIANGLE; // Font Awesome 6
        case ImGuiToastType::Error:
            return ICON_FK_EXCLAMATION_CIRCLE; // Font Awesome 6
        case ImGuiToastType::Info:
            return ICON_FK_INFO; // Font Awesome 6
        default:
            return nullptr;
        }
    }
...
namespace ImGui
{
    ...
    {
        if (notifications.size() >= NOTIFY_MAX_NOTIFICATIONS_COUNT) {
            notifications.clear();
        }
    ...
    inline void RenderNotifications()
    {
        ...
        for (size_t i = 0; i < notifications.size(); ++i)
        {
            ...
            ImGui::BringWindowToDisplayFront(GetCurrentWindow());
            ...
            // Here we render the toast content
            {
                ...
                if (NOTIFY_USE_DISMISS_BUTTON)
                {
                    ...
                    if (Button(ICON_FK_TIMES_CIRCLE))
                    {
                        RemoveNotification((int)i);
                    }
                }
...
namespace Editor {
    inline void RenderImGuiNotifications() {
